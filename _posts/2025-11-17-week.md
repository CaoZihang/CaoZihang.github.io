...
> POC: 很奇怪的设定，既然是总误差，就应该把政策设定作为一个参数；现在在定义中使用$\lambda^{true}$后面又用$\forall \lambda$非常混乱
...
若$\gamma<1, \rho,\pi>0$，当$N\to \infin$时，$\varepsilon_{tot}\to 0$

严格地讲，当$limit N\to\infin$时，有渐进紧确界$\varepsilon_{tot}^N=\Theta((1-\alpha)^N)$
