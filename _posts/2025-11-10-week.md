...
$\begin{aligned} \\dot{z}_j=&\\{\lambda_j + i \omega_j - \|z_j(t)\|^2\\}z_j(t)+R_j^ZS\sum\_{k=1}^NA_{jk}K_{jk}z_j(t-\tau_{jk})+\beta\xi_j(t)+u(t),\\\ &j=1,2,...,N\quad u(t)=\left\\{ \begin{array}{rcl}p,t_1<t<t_2\\\ 0,otherwise\end{array}\right. \end{aligned}$
