...
$\begin{aligned} \\dot{z}_j=&\\{\lambda_j + i \omega_j - \|z_j(t)\|^2\\}z_j(t)+R_j^ZS\sum\_{k=1}^NA\_{jk}K\_{jk}z_j(t-\tau\_{jk})+\beta\xi_j(t)+u(t),\\\ &j=1,2,...,N\quad u(t)=\left\\{ \begin{array}{rcl}a \\\ 0,otherwise\end{array} \right. \end{aligned}$
