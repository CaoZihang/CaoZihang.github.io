...
- Evaluation: the sample weighted zero-mean R-squared score $R^2 = 1 - \frac{\sum w_i(y_i - \hat{y_i})^2}{\sum w_i y_i^2}$
- Data: 79 features & 9 responders
  - forecast a given responder for up to 6 months in the future
  - training data: 4.5 million rows
  - test data: to be collected after submissions close
