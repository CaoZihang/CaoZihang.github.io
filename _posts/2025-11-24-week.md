...
增强型马尔可夫链转移矩阵$[ \begin{array}{c\|c} \underset{m \times m}{\Gamma_{\varepsilon \varepsilon'}} & \underset{m \times 2}{\Gamma_{\varepsilon z}} \\\ \hline \underset{2 \times m}{\Gamma_{z \varepsilon'}} & \underset{2 \times 2}{\Gamma_{z z'}}\end{array}]\equiv [ \begin{array}{ccccc\|cc} p_{11'} p_z & \dots & p_{1 \ell'} p_z & \dots & p_{1 m'} p_z & p_p & p_r \\\ \vdots & \ddots & \vdots & \ddots & \vdots & \vdots & \vdots \\\ p_{m 1'} p_z & \dots & p_{m \ell'} p_z & \dots & p_{m m'} p_z & p_p & p_r\\\ \hline 0 & \dots & 1 - p_{p p'} & \dots & 0 & p_{p p'} & 0 \\\ 0 & \dots & 1 - p_{r r'} & \dots & 0 & 0 & p_{r r'}\end{array}]$
...
$\widetilde{Q}\_t \widetilde{F}\_t = ( \frac{1 + i\_{\text{RoW}, t-1}}{1 + \widetilde{\pi}\_t} ) \widetilde{Q}_t \widetilde{F}\_{t-1} + \Delta\_{t-1} \frac{P_{t-1}}{P_t} + ( \frac{P_{H,t}}{P_t} C_{H,t}^* - \frac{P_{F,t}}{P_t} C_{F,t} ) + ( \frac{P_{H,t}}{P_t} \widetilde{C}\_{H,t} - \frac{P\_{\text{RoW},t}}{P_t} C_{\text{RoW},t} )$
