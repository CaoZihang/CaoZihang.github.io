...
$\widetilde{Q}\_t \widetilde{F}_t = \left( \frac{1 + i\_{\text{RoW}, t-1}}{1 + \widetilde{\pi}\_t} \right) \widetilde{Q}_t \widetilde{F}\_{t-1} + \Delta_{t-1} \frac{P_{t-1}}{P_t} + \left( \frac{P_{H,t}}{P_t} C_{H,t}^* - \frac{P_{F,t}}{P_t} C_{F,t} \right) + \left( \frac{P_{H,t}}{P_t} \widetilde{C}\_{H,t} - \frac{P\_{\text{RoW},t}}{P_t} C_{\text{RoW},t} \right)$
...
$\begin{aligned}N_t&=L_t\\\ A_t&=B_t+\widetilde{Q}\_t\widetilde{F}_t\\\ Y_{H,t}&=C_{H,t}+C_{H,t}^\ast+\widetilde{C}\_{H,t}+G\_{H,t}+\psi_t\end{aligned}$
