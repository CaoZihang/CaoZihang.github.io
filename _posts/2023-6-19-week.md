...
该公司声称采用了AHP，但又称三级指标权重基于变异系数法和专家意见，二级指标权重以经验和专家建议为主要参考依据，这与层次分析法相矛盾，以及从其完全整数的权重上看，我怀疑该指标并未使用AHP，该报告在方法上可能存在误用和主观干扰。

![image-20230913225629335](https://img.czhread.asia/img/202309132256209.png)
